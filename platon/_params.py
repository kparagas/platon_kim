...
class _CLRParam(_Param):
    def __init__(self, best_guess, ng, low_lim = None, high_lim = None):
        ...
        self.ppf = dl.load(open('/Users/kimparagas/desktop/jwst_project/clr_stuff/clr_prior_p3.pkl', 'rb'))
        
        clr_df = pd.read_csv(f'/Users/kimparagas/Desktop/jwst_project/clr_stuff/clr_priors/ng_{ng}_prior.csv',
             sep = '\t')
